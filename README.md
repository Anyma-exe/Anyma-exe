...
[![Email](https://img.shields.io/badge/anymaa@icloud.com-000000?style=flat-square&logo=apple&logoColor=white)](mailto:anymaa@icloud.com)
...
|---|---|---|
| [**neural-track**](https://github.com/Anyma-exe/neural-track) | Cognitive research tool measuring motor precision & micro-variability via Fitts's Law | React · TypeScript · Vite |
| [**cognitive-arcade**](https://github.com/Anyma-exe/cognitive-arcade) | Prototype battery of cognitive tasks (Stroop, N-Back, Go/No-Go) for neuroscientific exploration | JavaScript |
| [**attention-flow**](https://github.com/Anyma-exe/attention-flow) | EMA tool for tracking attentional variability in ecological settings | Python |
...
<div align="center">
<sub><i>"The mind is not a vessel to be filled, but a fire to be kindled." — Plutarch</i></sub>
</div>
